...
> 冻结输出：[freeze-zhenlian-import-and-cards-v1.md](/Users/myandong/Projects/marry2/docs/current/zhenlian/freeze-zhenlian-import-and-cards-v1.md)

### 4.1 导入落点对齐

- [x] 让手动建档、录音提取、PDF 导入共享同一套字段落点
- [x] 固定”AI 草稿 -> 人工确认 -> 正式写入”的基本流转
- [x] 预留微信截图识别入口，但不在第一阶段过度展开实现

### 4.2 资料与资料卡边界

- [x] 固定头像 / 生活照 / 认证材料 / 其他补充材料的语义边界
- [x] 固定内部完整版 / 对客介绍版 / 营销版的字段可见范围
- [x] 确认资料卡只消费已冻结字段，不再反向发明字段结构
...
- [x] 导入与资料卡冻结已达到可引用状态（`freeze-zhenlian-import-and-cards-v1.md`）
